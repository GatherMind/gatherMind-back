INSERT INTO member (member_id, nickname, password, created_at, email, profile_image, is_email_verified, oauth_provider, oauth_id, is_deleted) VALUES
('member1', 'Alpha', 'Password123', CURRENT_TIMESTAMP, 'user1@example.com', '/api/files/default-profile', false, 'LOCAL', UUID(), false),
('member2', 'Beta', 'Password456', CURRENT_TIMESTAMP, 'user2@example.com', '/api/files/default-profile', false, 'LOCAL', UUID(), false),
('member3', 'Gamma', 'Password789', CURRENT_TIMESTAMP, 'user3@example.com', '/api/files/default-profile', false, 'LOCAL', UUID(), false),
('member4', 'Delta', 'Password101', CURRENT_TIMESTAMP, 'user4@example.com', '/api/files/default-profile', false, 'LOCAL', UUID(), false),
('member5', 'Epsilon', 'Password202', CURRENT_TIMESTAMP, 'user5@example.com', '/api/files/default-profile', false, 'LOCAL', UUID(), false),
('member6', 'Zeta', 'Password303', CURRENT_TIMESTAMP, 'user6@example.com', '/api/files/default-profile', false, 'LOCAL', UUID(), false),
('member7', 'Eta', 'Password404', CURRENT_TIMESTAMP, 'user7@example.com', '/api/files/default-profile', false, 'LOCAL', UUID(), false),
('member8', 'Theta', 'Password505', CURRENT_TIMESTAMP, 'user8@example.com', '/api/files/default-profile', false, 'LOCAL', UUID(), false),
('member9', 'Iota', 'Password606', CURRENT_TIMESTAMP, 'user9@example.com', '/api/files/default-profile', false, 'LOCAL', UUID(), false),
('member10', 'Kappa', 'Password707', CURRENT_TIMESTAMP, 'user10@example.com', '/api/files/default-profile', false, 'LOCAL', UUID(), false),
('member11', 'Lambda', 'Password808', CURRENT_TIMESTAMP, 'user11@example.com', '/api/files/default-profile', false, 'LOCAL', UUID(), false),
('member12', 'Mu', 'Password909', CURRENT_TIMESTAMP, 'user12@example.com', '/api/files/default-profile', false, 'LOCAL', UUID(), false),
('member13', 'Nu', 'Password010', CURRENT_TIMESTAMP, 'user13@example.com', '/api/files/default-profile', false, 'LOCAL', UUID(), false),
('member14', 'Xi', 'Password111', CURRENT_TIMESTAMP, 'user14@example.com', '/api/files/default-profile', false, 'LOCAL', UUID(), false),
('member15', 'Omicron', 'Password222', CURRENT_TIMESTAMP, 'user15@example.com', '/api/files/default-profile', false, 'LOCAL', UUID(), false);
